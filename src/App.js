...
export default function PersonalInfo() {
  ...
  const isButtonDisabled = !name || !lastName || !hour;
    ...
    <div className='bg-gray-800 h-screen divide-y divide-white/5'>
      <div className='grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8'>
        <div>
          ...
          <p className='mt-1 text-sm leading-6 text-gray-400'>Zaman Dilimi :  </p> <p className='text-base font-semibold leading-7 text-white'> {hour} </p>
        </div>
